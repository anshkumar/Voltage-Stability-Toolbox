% spcomp_NRS_low.m file is written to search the singular points
...
x0=x;
% INITIALIZE NRS
% Obtain the smallest eigenvalue of Dy(g(x,y,p)) evaluated at the lower solution
           ...
           [f,J]=eval([CurrentSystem,'(data,x,[0;param],v)']);
            ...
            v(sub_strt:fn)=v0+delta_sp(2*no_pq+1:4*no_pq);
           	alpha_sp=alpha_sp0+delta_sp(4*no_pq+1);
				x(1:mm)=(1-alpha_sp)*x_low(1:mm)+alpha_sp*x_up(1:mm);
