...
%dynamic bifurcation analysis. One of the algebraic state variables are 
...
if SPfilename~=0,
    ...
    if isempty(findstr(CurrentFileName,CurrentSystem))
        ...
        dlgfig=mydlg(titleStr,textStr,'singpo | rtnnow')
        return;
    end
    ...
    singpo_fig=figure(...
        'NumberTitle','off',...
        'Name','Voltage Stability Toolbox - Singular Point Analysis',...
        'Resize','off',...
        'Position',position,...
        'MenuBar','none',...
        'Color',[0.7 0.8 0.9]);
