% MEX_PoC is the callback script for Model_Build_Load Flow Model. It
...
if filename~=0,
    ...
    if findstr(CurrentFileName,CurrentSystem)==[]
        ...
        dlgfig=mydlg(titleStr,textStr,'mex_poc | rtnnow');
        return;
    end
    ...
    C_Flag=0;
    t=clock;
    [Yred,Y_saffet,no_gen,no_pv,no_pq]=eqmodel(bus_type,bus_condc,...
    ...
    mexfuncname=mexpoc_c(pathname,filename,Yred);
