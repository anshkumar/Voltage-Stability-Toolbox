...
%Singpo_all_NR.m sets up GUI for singular points calculations. This M-file implements
%both NR and NRS algorithms to compute singular points at a given paramter value
% Before running this particular M-file,user should run the dynamic bifurcation program that
%computes lower of the nose curve.
...
if SPfilename~=0,
    ...
    if isempty(findstr(CurrentFileName,CurrentSystem))
        ...
        dlgfig=mydlg(titleStr,textStr,'singpo_all_NR | rtnnow')
        return;
    end
    ...
    singpo_fig=figure(...
        'NumberTitle','off',...
        'Name','Voltage Stability Toolbox - Singular Point Analysis(NR & NRS)',...
        'Resize','off',...
        'Position',position,...
        'MenuBar','none',...
        'Color',[0.7 0.8 0.9]);
...
%         'String','State Values');
     StateSlider=uicontrol(singpo_fig,...
        'Style','popupmenu',...
        'Position',[display_length*45-25,30,110,10],... % EDITED BY: Vedanshu
        'BackgroundColor','Y',...
    ...
    uicontrol(singpo_fig,...
        'Style','frame',...
        'BackgroundColor','b',...
        'Position',[25,310,5*85,44]);   % EDITED BY: Vedanshu
